...
const styles = StyleSheet.create({
  ...
  logoText: { fontSize: FONTS.sizes.base, fontWeight: '800', color: COLORS.primary },
  ...
  title: { fontSize: FONTS.sizes.xl, fontWeight: '800', color: COLORS.text, textAlign: 'center' },
  ...
  reasonTitle: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.error },
  ...
  infoCardTitle: { fontSize: FONTS.sizes.xs, fontWeight: '700', color: COLORS.textLight, textTransform: 'uppercase', letterSpacing: 0.7, marginBottom: SPACING.sm },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, paddingVertical: 4 },
  infoLabel: { fontSize: FONTS.sizes.sm, color: COLORS.textSecondary, fontWeight: '600', minWidth: 70 },
  ...
  stepsTitle: { fontSize: FONTS.sizes.sm, fontWeight: '700', color: COLORS.text, marginBottom: SPACING.xs },
  stepRow: { flexDirection: 'row', alignItems: 'flex-start', gap: SPACING.md },
  stepIconWrap: {
    width: 34, height: 34, borderRadius: 17, backgroundColor: COLORS.primaryLight,
    alignItems: 'center', justifyContent: 'center',
  },
  stepLabel: { fontSize: FONTS.sizes.sm, fontWeight: '700', color: COLORS.text },
  ...
  secondaryBtnText: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.primary },
