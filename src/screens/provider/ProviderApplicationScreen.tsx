            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.catName, form.category_id === item.id && { color: COLORS.primary, fontWeight: '700' }]}>{item.name}</Text>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.text, marginBottom: SPACING.sm },
  ...
  summaryLabel: { width: 70, fontSize: FONTS.sizes.sm, color: COLORS.textSecondary, fontWeight: '500' },
  summaryValue: { flex: 1, fontSize: FONTS.sizes.sm, color: COLORS.text, fontWeight: '600' },
  ...
  docLabel: { fontSize: FONTS.sizes.sm, fontWeight: '600', color: COLORS.text, flex: 1, marginRight: 8 },
  ...
  submittedLabel: { fontSize: FONTS.sizes.sm, fontWeight: '600', color: COLORS.text },
  ...
  approvedTitle: { fontSize: FONTS.sizes.xl, fontWeight: '800', color: COLORS.text, marginTop: SPACING.md, marginBottom: SPACING.xs },
  ...
  catName: { fontSize: FONTS.sizes.base, fontWeight: '600', color: COLORS.text },
