...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: FONTS.sizes.xs, fontWeight: '700', color: COLORS.textLight, textTransform: 'uppercase', letterSpacing: 0.7, marginBottom: SPACING.sm },
  infoCard: {
  ...
  infoValue: { fontSize: FONTS.sizes.sm, color: COLORS.text, fontWeight: '500', lineHeight: 20 },
  ...
  docType: { fontSize: FONTS.sizes.sm, fontWeight: '700', color: COLORS.text },
  ...
  actionFormTitle: { fontSize: FONTS.sizes.lg, fontWeight: '800', color: COLORS.text },
  actionFormInput: {
  ...
  cancelBtnText: { fontSize: FONTS.sizes.base, fontWeight: '600', color: COLORS.text },
  confirmBtn: {
    flex: 1, alignItems: 'center', justifyContent: 'center',
    paddingVertical: SPACING.md, borderRadius: BORDER_RADIUS.xl, ...SHADOWS.small,
  },
  confirmBtnText: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.white },
