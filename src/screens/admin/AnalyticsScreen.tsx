...
const styles = StyleSheet.create({
  ...
  kpiValue: { fontSize: FONTS.sizes.xxl, fontFamily: FONTS.bold, color: COLORS.text },
  ...
  barCount: { fontSize: FONTS.sizes.sm, fontFamily: FONTS.semiBold, color: COLORS.text, width: 28, textAlign: 'right' },
  catRow: { flexDirection: 'row', alignItems: 'center', gap: SPACING.sm, marginBottom: SPACING.sm },
  catRank: { fontSize: FONTS.sizes.sm, fontFamily: FONTS.semiBold, color: COLORS.primary, width: 24 },
  ...
  catCount: { fontSize: FONTS.sizes.sm, fontFamily: FONTS.semiBold, color: COLORS.text, width: 28, textAlign: 'right' },
});
