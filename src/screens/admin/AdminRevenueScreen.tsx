...
export default function AdminRevenueScreen() {
  ...
  const combined: RevenueSource = {
    today:     bookings.today     + featured.today     + tips.today,
    thisMonth: bookings.thisMonth + featured.thisMonth + tips.thisMonth,
    lifetime:  bookings.lifetime  + featured.lifetime  + tips.lifetime,
  };
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        {/* Combined totals */}
        <Text style={styles.sectionLabel}>Total Revenue (All Sources)</Text>
        <View style={styles.totalsRow}>
          {[
            { label: 'Today',      value: fmtPHP(combined.today) },
            { label: 'This Month', value: fmtPHP(combined.thisMonth) },
            { label: 'Lifetime',   value: fmtPHP(combined.lifetime) },
          ].map((c) => (
            <View key={c.label} style={styles.totalCard}>
              <Text style={styles.totalValue}>{c.value}</Text>
        ...
        {/* Service Bookings — no dedicated drill-down screen */}
