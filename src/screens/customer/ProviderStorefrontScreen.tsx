...
const styles = StyleSheet.create({
  ...
  hoursSection: { marginTop: SPACING.md, alignItems: 'center' },
  hoursTitle: { fontSize: FONTS.sizes.base, fontFamily: FONTS.semiBold, color: COLORS.text, marginBottom: SPACING.xs, textAlign: 'center' },
  hoursRow: { flexDirection: 'column', alignItems: 'center', paddingVertical: 4 },
  hoursDays: { fontSize: FONTS.sizes.sm, color: COLORS.textSecondary, textAlign: 'center' },
  hoursTime: { fontSize: FONTS.sizes.sm, fontFamily: FONTS.semiBold, color: COLORS.text, marginTop: 2, textAlign: 'center' },
});
