...
const styles = StyleSheet.create({
  ...
  providerName: { fontSize: FONTS.sizes.xl, fontWeight: '800', color: COLORS.text, marginTop: SPACING.sm },
  ...
  metricValue: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.text },
  ...
  badgeChipText: { fontSize: FONTS.sizes.xs, color: COLORS.primary, fontWeight: '600' },
  ...
  bookBtnText: { color: COLORS.white, fontWeight: '700', fontSize: FONTS.sizes.sm },
  ...
  beforeAfterText: { color: COLORS.white, fontSize: 10, fontWeight: '600' },
  reviewCard: {
    backgroundColor: COLORS.surface, borderRadius: BORDER_RADIUS.lg,
  ...
  reviewMeta: { flex: 1 },
  reviewName: { fontSize: FONTS.sizes.base, fontWeight: '700', color: COLORS.text },
  ...
  chatBtnText: { fontSize: 10, color: COLORS.primary, fontWeight: '600', marginTop: 2 },
  mainBookBtn: {
    flex: 1, height: 48, borderRadius: BORDER_RADIUS.lg,
    backgroundColor: COLORS.primary, alignItems: 'center', justifyContent: 'center',
  },
  mainBookBtnText: { color: COLORS.white, fontWeight: '800', fontSize: FONTS.sizes.base },
});
