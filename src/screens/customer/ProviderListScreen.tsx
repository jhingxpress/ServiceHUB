...
const styles = StyleSheet.create({
  ...
  resultCount: { fontSize: FONTS.sizes.sm, color: COLORS.textSecondary, fontWeight: '500' },
  ...
  ratingPillText: { fontSize: FONTS.sizes.xs, fontWeight: '700', color: '#92400E' },
  locRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  locText: { fontSize: FONTS.sizes.xs, color: COLORS.textLight, maxWidth: 120 },
  listCardRight: { alignItems: 'center' },
  rateText: { fontSize: FONTS.sizes.base, fontWeight: '800', color: COLORS.primary },
  ...
  gridName: { fontSize: FONTS.sizes.sm, fontWeight: '700', color: COLORS.text, marginTop: SPACING.sm },
  ...
  gridRatingText: { fontSize: FONTS.sizes.xs, fontWeight: '700', color: COLORS.text },
  gridRate: { fontSize: FONTS.sizes.xs, color: COLORS.primary, fontWeight: '700', marginTop: 3 },
